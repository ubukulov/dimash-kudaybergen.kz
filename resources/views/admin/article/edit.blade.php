                ...
                <form role="form" action="{{ route('admin.article.update', ['id' => $article->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" cols="30" rows="5" class="form-control" required>{!! $article->description !!}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Полное описание</label>
                            <textarea name="full_description" id="editor1" class="form-control" cols="30" rows="5" required>{!! $article->full_description !!}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Картинка</label>
                            @if(!empty($article->image))
                                <img width="150" src="{{ $article->getImageThumbs() }}" alt=""> <br><br>
